 ...
 * Lists all PDF documents with management options
 */
    ...
    const fetchDocuments = useCallback(async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `/api/admin/documents?status=${statusFilter}&page=${page}&limit=20`,
                {
                    headers: {
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage your secure PDF documents</p>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-16 text-muted-foreground border-2 border-dashed border-muted rounded-lg bg-muted/5">
                            ...
                            <p className="mb-6 max-w-sm text-center">
                                You haven&apos;t uploaded any documents yet. Start by uploading a new PDF.
                            </p>
                            <Button asChild>
                                <Link href="/admin/documents/new">
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <Button asChild variant="ghost" size="icon" className="h-8 w-8" title="Edit">
                                                        <Link href={`/admin/documents/${doc.docId}/edit`}>
